...
CREATE TABLE SUPPLY_PARAMETERS_TABLE (
 ...
 CREATE TABLE LOCATION_REPORTS_TABLE (
 
            LOCATION_REPORT_ID INT AUTO_INCREMENT,
            SUPPLY_CHARACTERISTICS_ID INT,
            PARTICULAR_INSTAL_OR_PROTECTIVE_CONDCUTOR VARCHAR(255),
			BOUNDING_OR_EARTHING VARCHAR(255),
            ...
            CONSTRAINT PK_LOCATION_REPORT_ID PRIMARY KEY(LOCATION_REPORT_ID),
            CONSTRAINT FK_LOCATION_REPORTS_SUPPLY_CHARACTERISTICS_ID FOREIGN KEY (SUPPLY_CHARACTERISTICS_ID) REFERENCES SUPPLY_CHARACTERISTICS_TABLE(SUPPLY_CHARACTERISTICS_ID) ON DELETE CASCADE
