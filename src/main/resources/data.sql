...
CREATE TABLE supply_observation_table(

		   SUPPLY_OBSERVATION_ID INT AUTO_INCREMENT,
		   SUPPLY_CHARACTERISTICS_ID INT,
		   OBSERVATION_COMPONENT_DETAILS VARCHAR(500),
		   CONSTRAINT PK_SUPPLY_OBSERVATION_ID PRIMARY KEY(SUPPLY_OBSERVATION_ID),
...
CREATE TABLE supply_obervations_table(

		   SUPPLY_OBSERVATIONS_ID INT AUTO_INCREMENT,
		   SUPPLY_OBSERVATION_ID INT,
		   OBSERVATIONS VARCHAR(500),
		   CONSTRAINT PK_INSPECTION_OBSERVATIONS_ID PRIMARY KEY(INSPECTION_OBSERVATIONS_ID),
           CONSTRAINT FK_OBSERVATIONS_SUPPLY_OBSERVATION_ID  FOREIGN KEY (SUPPLY_OBSERVATION_ID) REFERENCES SUPPLY_OBSERVATION_TABLE(SUPPLY_OBSERVATION_ID) ON DELETE CASCADE
...
CREATE TABLE inspection_obervation_table(

		   INSPECTION_OBSERVATION_ID INT AUTO_INCREMENT,
		   PERIODIC_INSPECTION_ID INT,
		   OBSERVATION_COMPONENT_DETAILS VARCHAR(500),
		   CONSTRAINT PK_INSPECTION_OBSERVATION_ID PRIMARY KEY(INSPECTION_OBSERVATION_ID),
           CONSTRAINT FK_OBSERVATION_PERIODIC_INSPECTION_ID  FOREIGN KEY (PERIODIC_INSPECTION_ID) REFERENCES PERIODIC_INSPECTION_TABLE(PERIODIC_INSPECTION_ID) ON DELETE CASCADE

);

CREATE TABLE inspection_obervations_table(

		   INSPECTION_OBSERVATIONS_ID INT AUTO_INCREMENT,
		   INSPECTION_OBSERVATION_ID INT,
		   OBSERVATIONS VARCHAR(500),
		   CONSTRAINT PK_INSPECTION_OBSERVATIONS_ID PRIMARY KEY(INSPECTION_OBSERVATIONS_ID),
           CONSTRAINT FK_OBSERVATIONS_INSPECTION_OBSERVATION_ID  FOREIGN KEY (INSPECTION_OBSERVATION_ID) REFERENCES INSPECTION_OBERVATIONS_TABLE(INSPECTION_OBSERVATION_ID) ON DELETE CASCADE
...
CREATE TABLE testing_obervation_table(

		   TESTING_OBSERVATION_ID INT AUTO_INCREMENT,
		   TESTING_REPORT_ID INT,
		   OBSERVATION_COMPONENT_DETAILS VARCHAR(500),
		   CONSTRAINT PK_TESTING_OBSERVATION_ID PRIMARY KEY(TESTING_OBSERVATION_ID),
           CONSTRAINT FK_OBSERVATION_TESTING_REPORT_ID FOREIGN KEY (TESTING_REPORT_ID) REFERENCES TESTING_REPORTS_TABLE(TESTING_REPORT_ID) ON DELETE CASCADE

);

CREATE TABLE testing_obervations_table(

		   TESTING_OBSERVATIONS_ID INT AUTO_INCREMENT,
		   TESTING_OBSERVATION_ID INT,
		   OBSERVATIONS VARCHAR(500),
		   CONSTRAINT PK_TESTING_OBSERVATIONS_ID PRIMARY KEY(TESTING_OBSERVATIONS_ID),
           CONSTRAINT FK_OBSERVATIONS_TESTING_OBSERVATION_ID  FOREIGN KEY (TESTING_OBSERVATION_ID) REFERENCES TESTING_OBERVATION_TABLE(TESTING_OBSERVATION_ID) ON DELETE CASCADE
...
CREATE TABLE observations_table (
			...
			SUMMARY_ID INT,
            OBSERVATIONS_SUPPLY  VARCHAR(2000),
            OBSERVATIONS_INSPECTION VARCHAR(2000),
            OBSERVATIONS_TESTING  VARCHAR(2000),
