...
-----------> Registration_license_table <----------
CREATE TABLE registered_license_table(
			 REGISTERED_LICENSE_ID INT AUTO_INCREMENT,
			 REGISTER_ID INT,
			 NO_OF_LICENSE INT,
			 LICENSE_AMOUNT INT,
			 PAYMENT_PHONE_NO VARCHAR(255),
			 PAYMENT_STATUS VARCHAR(255),
			 PAYMENT_FAILED_DESCRIPTION VARCHAR(255),
			 ORDER_ID VARCHAR(255),
			 CREATED_DATE datetime NOT NULL,
			 UPDATED_DATE datetime NOT NULL,
			 
			 CONSTRAINT PK_REGISTERED_LICENSE_ID PRIMARY KEY(REGISTERED_LICENSE_ID),
			 CONSTRAINT FK_REGISTER_ID FOREIGN KEY (REGISTER_ID) REFERENCES site_table(REGISTER_ID) ON DELETE CASCADE
 );