...
CREATE TABLE supply_alternativeInner_obervations_table(
...
CREATE TABLE inspection_outer_obervation_table(
...
CREATE TABLE inspection_inner_obervations_table(
           ...
           CONSTRAINT FK_INSPECTION_OUTER_OBSERVATION_ID  FOREIGN KEY (INSPECTION_OUTER_OBSERVATION_ID) REFERENCES INSPECTION_OUTER_OBERVATION_TABLE(INSPECTION_OUTER_OBSERVATION_ID) ON DELETE CASCADE
...
CREATE TABLE testing_outer_obervation_table(

		   TESTING_OUTER_OBSERVATION_ID INT AUTO_INCREMENT,
		   TESTING_REPORT_ID INT,
		   OBSERVATION_COMPONENT_DETAILS VARCHAR(225),
		   OBSERVATION_DESCRIPTION VARCHAR(500),
		   CONSTRAINT PK_TESTING_OUTER_OBSERVATION_ID PRIMARY KEY(TESTING_OUTER_OBSERVATION_ID),
...
CREATE TABLE testing_inner_obervations_table(

		   TESTING_INNER_OBSERVATIONS_ID INT AUTO_INCREMENT,
		   TESTING_OUTER_OBSERVATION_ID INT,
		   OBSERVATION_COMPONENT_DETAILS VARCHAR(225),
		   OBSERVATION_DESCRIPTION VARCHAR(500),
		   CONSTRAINT PK_TESTING_INNER_OBSERVATIONS_ID PRIMARY KEY(TESTING_INNER_OBSERVATIONS_ID),
           CONSTRAINT FK_TESTING_OUTER_OBSERVATION_ID FOREIGN KEY (TESTING_OUTER_OBSERVATION_ID) REFERENCES TESTING_OUTER_OBERVATION_TABLE(TESTING_OUTER_OBSERVATION_ID) ON DELETE CASCADE
