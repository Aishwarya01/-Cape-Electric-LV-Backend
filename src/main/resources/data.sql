...
CREATE TABLE testing_records_voltage (

                VOLTAGE_ID INT AUTO_INCREMENT,
				TESTING_RECORD_ID INT,
				TEST_VOLTAGE VARCHAR(225),
				CONSTRAINT PK_VOLTAGE_ID PRIMARY KEY(VOLTAGE_ID),
				CONSTRAINT FK_VOLTAGE_TESTING_RECORD_ID FOREIGN KEY (TESTING_RECORD_ID) REFERENCES TESTING_RECORDS_TABLE(TESTING_RECORD_ID) ON DELETE CASCADE     
				
	);

CREATE TABLE testing_records_loopimpedance (

                LOOPIMPEDANCE_ID INT AUTO_INCREMENT,
				TESTING_RECORD_ID INT,
				TEST_LOOPIMPEDANCE VARCHAR(225),
				CONSTRAINT PK_LOOPIMPEDANCE_ID PRIMARY KEY(LOOPIMPEDANCE_ID),
				CONSTRAINT FK_TESTING_RECORD_ID FOREIGN KEY (TESTING_RECORD_ID) REFERENCES TESTING_RECORDS_TABLE(TESTING_RECORD_ID) ON DELETE CASCADE     
				
	);

CREATE TABLE testing_records_faultcurrent (

                FAULTCURRENT_ID INT AUTO_INCREMENT,
				TESTING_RECORD_ID INT,
				TEST_FAULTCURRENT VARCHAR(225),
				CONSTRAINT PK_FAULTCURRENT_ID PRIMARY KEY(FAULTCURRENT_ID),
				CONSTRAINT FK_FAULTCURRENT_TESTING_RECORD_ID FOREIGN KEY (TESTING_RECORD_ID) REFERENCES TESTING_RECORDS_TABLE(TESTING_RECORD_ID) ON DELETE CASCADE     
				
	);
	
CREATE TABLE testing_records_disconnectiontime (

                DISCONNECTION_TIME_ID INT AUTO_INCREMENT,
				TESTING_RECORD_ID INT,
				DISCONNECTION_TIME VARCHAR(225),
				CONSTRAINT PK_DISCONNECTION_TIME_ID PRIMARY KEY(DISCONNECTION_TIME_ID),
				CONSTRAINT FK_DISCONNECTIONTIME_TESTING_RECORD_ID FOREIGN KEY (TESTING_RECORD_ID) REFERENCES TESTING_RECORDS_TABLE(TESTING_RECORD_ID) ON DELETE CASCADE     
