...
CREATE TABLE testing_incomming_distribution_table (

                INCOMMING_DISTRIBUTION_ID INT AUTO_INCREMENT,
				DISTRIBUTION_ID INT,
				INCOMING_VOLTAGE VARCHAR(225),
				INCOMING_LOOPIMPEDANCE VARCHAR(225),
				INCOMING_FAULTCURRENT VARCHAR(225),
				SOURCE_FROM_SUPPLY VARCHAR(225),
				CONSTRAINT PK_INCOMMING_ID PRIMARY KEY(INCOMMING_DISTRIBUTION_ID),
				CONSTRAINT FK_INCOMMING_DISTRIBUTION_ID FOREIGN KEY (DISTRIBUTION_ID) REFERENCES TESTING_DISTRIBUTION_TABLE(DISTRIBUTION_ID) ON DELETE CASCADE     
