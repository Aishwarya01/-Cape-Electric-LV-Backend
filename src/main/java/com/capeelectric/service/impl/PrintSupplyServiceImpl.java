...
//					document.add(table15);
					...
					PdfPCell cell291 = new PdfPCell(new Paragraph(supply.getMainNominalFrequency(), font6));
...
//				}
				...
				table12.addCell(new Phrase("Size of main protective earthing conductor (unit sq.mm):", font9));
				...
				if (comments.getViewerUserName() != null && comments.getInspectorUserName() != null) {
					...
					PdfPCell cell3811 = new PdfPCell(new Paragraph(comments.getInspectorUserName(), font91));
					cell3811.setHorizontalAlignment(Element.ALIGN_CENTER);
