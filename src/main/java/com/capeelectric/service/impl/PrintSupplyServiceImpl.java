...
//						table34.setSpacingBefore(10f); // Space before table
					...
					if (supply.getAlternativeSupply().equals("Yes")) {
						...
						PdfPCell cell10 = new PdfPCell(
								new Paragraph(8, "Number of alternate sources of supply:", font9));
					...
					PdfPCell cell35 = new PdfPCell(new Paragraph(
							"Main protective bonding conductor continuity and connection verified :", font9));
					...
					PdfPCell cell41 = new PdfPCell(
							new Paragraph("Material of main protective earthing conductor:", font9));
