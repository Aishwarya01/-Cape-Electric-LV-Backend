...
public class InspectionServiceImplPDF implements InspectionServicePDF {
		...
		if (userName != null && !userName.isEmpty() && siteId != null) {
			...
			try {
				...
				Paragraph paragraph1 = new Paragraph(
						"TIC of LV electrical installation", font11B);
	...
	private void inspectionIteration(Document document, IpaoInspection ipoInspection, ConsumerUnit consumerUnit,
		...
		Font font10B =  new Font(BaseFont.createFont( ), 10, Font.NORMAL | Font.BOLD,
				BaseColor.BLACK);
		...
		PdfPCell cell80 = new PdfPCell(
				new Paragraph(ipoInspection.getLocationNumber().toString()));
...
//		cell.setFixedHeight(30f);
		...
		PdfPCell cell37= new PdfPCell(new Paragraph("Service cut out / fuse:",
				 new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
...
//		cell2.setFixedHeight(30f);
		...
		PdfPCell cell38= new PdfPCell(new Paragraph("Meter tails – Consumer:",
				new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
...
//		cell4.setFixedHeight(30f);
		...
		Paragraph paragraph8 = new Paragraph(
				"Note: Where inadequacies in distributor’s equipment are encountered, it is recommended that the user informs this to the appropriate authority.", noteFont);
...
//		table2.setSpacingBefore(5f); // Space before table
		...
		PdfPCell cell6 = new PdfPCell(
				new Paragraph(ipoInspection.getEarthingArrangement(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		table2.addCell(new Phrase("Dedicated earthing arrangement independent to that of public supply:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		cell6.setFixedHeight(15f);
		cell6.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell6.setBorder(PdfPCell.NO_BORDER);
		table2.addCell(cell6);
		
		PdfPCell cell40= new PdfPCell(new Paragraph("Presence of adequate arrangements where generator to operate in parallel with the public supply system:",
				new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell7 = new PdfPCell(
				new Paragraph(ipoInspection.getAdequateArrangement(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell8 = new PdfPCell(
				new Paragraph(ipoInspection.getConnectionGenerator(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		table2.addCell(new Phrase("Correct connections of generator in parallel. (note: Special attention to circulating currents):", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell9 = new PdfPCell(
				new Paragraph(ipoInspection.getCompatibilityCharacteristics(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell10 = new PdfPCell(
				new Paragraph(ipoInspection.getAutomaticDisconnectGenerator(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		table2.addCell(new Phrase("Means to provide automatic disconnection of generator in the event of loss of public supply system or voltage or frequency deviation beyond declared values:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		cell10.setFixedHeight(15f);
		cell10.setHorizontalAlignment(Element.ALIGN_CENTER);
		cell10.setBorder(PdfPCell.NO_BORDER);
		table2.addCell(cell10);
		
		PdfPCell cell42= new PdfPCell(new Paragraph("Means to prevent connection of generator in the event of loss of public supply system or voltage or frequency deviation beyond declared values:",
				new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell11 = new PdfPCell(
				new Paragraph(ipoInspection.getPreventConnectGenerator(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		table2.addCell(new Phrase("Means to isolate generator from the public supply system :", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
...
//		table3.setSpacingBefore(10f); // Space before table
		...
		table3.addCell(new Phrase("Main earthing / bonding arrangements:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
//		cell14.setFixedHeight(25f);
		...
		PdfPCell cell43= new PdfPCell(new Paragraph("Presence and adequacy of energy suppliers earthing arrangement or installation earth electrode arrangement:",
				new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell15 = new PdfPCell(
				new Paragraph(ipoInspection.getEarthElectordeArrangement(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell16 = new PdfPCell(
				new Paragraph(ipoInspection.getEarthConductorConnection(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		table3.addCell(new Phrase("Presence and adequacy of earthing conductor and connections:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
//		cell16.setFixedHeight(30f);
		...
		table3.addCell(new Phrase("Presence and adequacy of main protective bonding conductors and connections (colour, sizes, termination, and provision of independent earthing):", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
//		cell18.setFixedHeight(45f);
		...
		PdfPCell cell20 = new PdfPCell(
				new Paragraph(ipoInspection.getAllAppropriateLocation(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		table3.addCell(new Phrase("Presence and adequacy of electrical earthing/bonding labels at all appropriate locations:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
//		cell20.setFixedHeight(35f);
		...
		Paragraph paragraph13 = new Paragraph("Applicable to locations where automatic disconnection of supply is not employed. If any of the methods listed below are employed details should be provided on separate page", noteFont);
		...
		table4.addCell(new Phrase("SELV system, including the source and associated circuits:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		table4.addCell(new Phrase("Double insulation (Class II or equivalent equipment and associated circuits):", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell25 = new PdfPCell(
				new Paragraph(ipoInspection.getReinforcedInsulation(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		table4.addCell(new Phrase("Electrical separation for one item of equipment (shaver supply unit):", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		PdfPCell cell27 = new PdfPCell(
				new Paragraph(ipoInspection.getInsulationLiveParts(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		table5.addCell(new Phrase("Insulation of live parts (conductors completely covered with durable insulating material):", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
...
//		table6.setSpacingAfter(10f); // Space after table
		...
		PdfPCell cell32 = new PdfPCell(
				new Paragraph(ipoInspection.getFaultNonConductLocation(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		table6.addCell(new Phrase("Non-Conducting location – earth free local equipotential bonding:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
//		cell32.setFixedHeight(35f);
		...
		PdfPCell cell33 = new PdfPCell(
				new Paragraph(ipoInspection.getFaultElectricalSepartion(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
		...
		table7.addCell(new Phrase("RCD(s) not exceeding 30 mA operating current:", new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
//		cell34.setFixedHeight(30f);
		...
		PdfPCell cell35= new PdfPCell(
				new Paragraph(ipoInspection.getSupplementaryBonding(), new Font(BaseFont.createFont( ), 10, Font.NORMAL)));
	...
	private void addRow(PdfPTable table8, String string, String string2, String string3) throws DocumentException, IOException {
	...
	private void addRow1(PdfPTable table9, String string, String string2, String string3) throws DocumentException, IOException {
	...
	private void addRow2(PdfPTable table10, String string, String string2, String string3) throws DocumentException, IOException {
	...
	private void addRow3(PdfPTable table11, String string, String string2, String string3) throws DocumentException, IOException {
