...
public class PrintTestingServiceImpl implements PrintTestingService {
	...
	private void testingIteration(Document document, Testing testing1) throws DocumentException, IOException {
		 ...
		 * TestDistribution distribution = testDistribution.get(0); List<TestingRecords>
		 * testRecords = testing1.getTestingRecords(); String incomingVoltage =
		 * distribution.getIncomingVoltage(); String incomingVoltage_list[] =
		 * incomingVoltage.split(","); String IV1 = incomingVoltage_list[0]; String IV2
		 * = incomingVoltage_list[1]; String IV3 = incomingVoltage_list[2]; String IV4 =
		 * incomingVoltage_list[3]; String IV5 = incomingVoltage_list[4]; String IV6 =
		 * incomingVoltage_list[5]; String IV7 = incomingVoltage_list[6]; String IV8 =
		 * incomingVoltage_list[7]; String IV9 = incomingVoltage_list[8];
		 * 
		 * String incomingIPF = distribution.getIncomingVoltage(); String
		 ...
		 * incomingIPF_list[8];
		 * 
		 * String incomingZS = distribution.getIncomingVoltage(); String
		 ...
		 * incomingZS_list[7]; String ZS9 = incomingZS_list[8]; float[]
		 * pointColumnWidths = { 60F, 80F }; PdfPTable table = new
		 ...
		 * Font.NORMAL | Font.BOLD, BaseColor.BLACK); PdfPTable table13 = new
		 * PdfPTable(1); table13.setWidthPercentage(100); // Width 100%
		 * table13.setSpacingBefore(10f); // Space before table
		 ...
		 * Paragraph(testing1.getLocationNumber().toString(), font7)); table.addCell(new
		 * Phrase("Location Number :", font7)); cell.setBorder(PdfPCell.NO_BORDER);
		 * table.addCell(cell);
		 * 
		 * PdfPCell cell1 = new PdfPCell(new Paragraph("Location Name :", font7));
		 * cell1.setBorder(PdfPCell.NO_BORDER); cell1.setGrayFill(0.92f);
		 * table.addCell(cell1); PdfPCell cell22 = new PdfPCell(new
		 * Paragraph(testing1.getLocationName(), font7)); cell22.setGrayFill(0.92f);
		 * cell22.setBorder(PdfPCell.NO_BORDER); table.addCell(cell22);
		 * 
		 ...
		 * font7)); table.addCell(new Phrase("Designation:", font7));
		 * cell5.setBorder(PdfPCell.NO_BORDER); table.addCell(cell5);
		 * 
		 * PdfPCell cell6 = new PdfPCell(new Paragraph("Company Name:", font7));
		 * cell6.setBorder(PdfPCell.NO_BORDER); cell6.setGrayFill(0.92f);
		 * table.addCell(cell6); PdfPCell cell24 = new PdfPCell(new
		 * Paragraph(testing1.getCompanyName(), font7)); cell24.setGrayFill(0.92f);
		 * cell24.setBorder(PdfPCell.NO_BORDER); table.addCell(cell24);
		 * 
		 * PdfPCell cell7 = new PdfPCell(new
		 * Paragraph(testing1.getDetailsTestInstrument(), font7)); table.addCell(new
		 * Phrase("Details Of Test Instrument:", font7));
		 * cell7.setBorder(PdfPCell.NO_BORDER); table.addCell(cell7);
		 * 
		 * PdfPCell cell8 = new PdfPCell(new Paragraph("Continuity:", font7));
		 * cell8.setBorder(PdfPCell.NO_BORDER); cell8.setGrayFill(0.92f);
		 * table.addCell(cell8); PdfPCell cell25 = new PdfPCell(new
		 * Paragraph(testing1.getContinuity(), font7)); cell25.setGrayFill(0.92f);
		 * cell25.setBorder(PdfPCell.NO_BORDER); table.addCell(cell25);
		 * 
		 * PdfPCell cell9 = new PdfPCell(new
		 * Paragraph(testing1.getInsulationResisance(), font7)); table.addCell(new
		 * Phrase("Insulation Resistance:", font7));
		 * cell9.setBorder(PdfPCell.NO_BORDER); table.addCell(cell9);
		 * 
		 * PdfPCell cell10 = new PdfPCell(new Paragraph("Impedance:", font7));
		 * cell10.setBorder(PdfPCell.NO_BORDER); cell10.setGrayFill(0.92f);
		 * table.addCell(cell10); PdfPCell cell26 = new PdfPCell(new
		 * Paragraph(testing1.getImpedance(), font7)); cell26.setGrayFill(0.92f);
		 * cell26.setBorder(PdfPCell.NO_BORDER); table.addCell(cell26);
		 * 
		 * PdfPCell cell11 = new PdfPCell(new Paragraph(testing1.getRcd(), font7));
		 * table.addCell(new Phrase("RCD:", font7));
		 * cell11.setBorder(PdfPCell.NO_BORDER); table.addCell(cell11);
		 * 
		 * PdfPCell cell12 = new PdfPCell(new Paragraph("Earth Electrode Resistance:",
		 * font7)); cell12.setBorder(PdfPCell.NO_BORDER); cell12.setGrayFill(0.92f);
		 * table.addCell(cell12); PdfPCell cell27 = new PdfPCell(new
		 * Paragraph(testing1.getEarthElectrodeResistance(), font7));
		 * cell27.setGrayFill(0.92f); cell27.setBorder(PdfPCell.NO_BORDER);
		 * table.addCell(cell27); document.add(table);
		 * 
		 ...
		 * cell14.setBorder(PdfPCell.NO_BORDER); cell14.setGrayFill(0.92f);
		 ...
		 * cell17.setBorder(PdfPCell.NO_BORDER); table1.addCell(cell17);
		 * 
		 * PdfPCell cell18 = new PdfPCell(new
		 * Paragraph("Installed Equipment Vulnarable To Testing:", font7));
		 * cell18.setBorder(PdfPCell.NO_BORDER); cell18.setGrayFill(0.92f);
		 * table1.addCell(cell16); PdfPCell cell32 = new PdfPCell(new
		 ...
		 * Paragraph(distribution.getNumOutputCircuitsUse(), font5)); table1.addCell(new
		 * Phrase("Number Of Output Circuits In Use:", font5));
		 * cell19.setBorder(PdfPCell.NO_BORDER); table1.addCell(cell19);
		 * 
		 ...
		 * Width 100%
		 * 
		 * table2.getDefaultCell().setBorder(0); PdfPTable table34 = new PdfPTable(10);
		 * table34.setSpacingBefore(10f); // Space before table
		 * table34.setWidthPercentage(100); // Width 100%
		 * table34.getDefaultCell().setBorder(0); tableHead(table34); addRow(table2,
		 * "Incoming Voltage", IV1, IV2, IV3, IV4, IV5, IV6, IV7, IV8, IV9);
		 * addRow(table2, "Incoming Zs (Ω)", IPF1, IPF2, IPF3, IPF4, IPF5, IPF6, IPF7,
		 * IPF8, IPF9); addRow(table2, "Incoming Ipf (Amps) ", ZS1, ZS2, ZS3, ZS4, ZS5,
		 * ZS6, ZS7, ZS8, ZS9); document.add(table34); document.add(table2);
		 * 
		 * document.newPage(); for (TestingRecords testingRecords11 : testRecords) {
