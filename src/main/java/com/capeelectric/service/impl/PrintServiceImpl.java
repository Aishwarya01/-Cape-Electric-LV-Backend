	...
	public void printSummary(String userName, Integer siteId) throws SummaryException {
		if (userName != null && !userName.isEmpty() && siteId != null && siteId != 0) {
			...
			try {
				...
				Font font61 = new Font(BaseFont.createFont(), 12, Font.NORMAL, BaseColor.BLACK);
				...
				PdfPCell cell578 = new PdfPCell(new Paragraph("", font61));
