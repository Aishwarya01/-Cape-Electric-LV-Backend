...
public class PrintServiceImpl implements PrintService {
	...
	public void printSummary(String userName, Integer siteId) throws SummaryException {
		...
		//		Font red = new Font(FontFamily.HELVETICA, 30, Font.ITALIC);
			    Font font = new Font(Font.FontFamily.TIMES_ROMAN, 20,
	                      Font.ITALIC | Font.BOLD, BaseColor.BLACK );
				Paragraph paragraphOne = new Paragraph("Section 5", font);
				paragraphOne.setAlignment(Element.ALIGN_CENTER);
				Paragraph paragraphOne1 = new Paragraph("Observations, Recommendations and Summery", font);
				paragraphOne1.setAlignment(Element.ALIGN_CENTER);
				  Font font1 = new Font(Font.FontFamily.TIMES_ROMAN, 12,
	                      Font.ITALIC | Font.BOLD );
				Paragraph paragraphOne2 = new Paragraph(20,"(Initial and periodic inspection of an existing installation up to 1000 V AC and 1500 V DC)", font1);
...
//	                      Font.ITALIC , BaseColor.BLACK );
					 Font font4 = new Font(Font.FontFamily.TIMES_ROMAN, 14,
		                      Font.ITALIC | Font.BOLD, BaseColor.BLACK );
...
//				paragraphOne3.setAlignment(Element.ALIGN_CENTER);
				...
				PdfPCell cell = new PdfPCell(new Paragraph(summary.getExtentInstallation(),new Font(BaseFont.createFont(), 12,Font.NORMAL)));
				table4.addCell(new Phrase("Extent Of Installation Covered By This Report:", new Font(BaseFont.createFont(), 12,Font.ITALIC)));
				// cell.setNoWrap(false);
				// cell.setColspan(BaseColor.BLUE);
			...
			//	cell.setBorderColor(Color.GREEN); 
				...
				table4.addCell(cell);
				PdfPCell cell1 = new PdfPCell(new Paragraph(summary.getAgreedLimitations(),new Font(BaseFont.createFont(), 12,Font.NORMAL)));
			    table4.addCell(new Phrase("Agreed Limitations Including The Reasons:", new Font(BaseFont.createFont(), 12,Font.ITALIC)));
				cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell1.setFixedHeight(30f);
				cell1.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell1);

				PdfPCell cell2 = new PdfPCell(new Paragraph(summary.getAgreedWith(), new Font(BaseFont.createFont(), 12,Font.NORMAL)));
				//table4.addCell("Agreed With");
				...
				PdfPCell cell3 = new PdfPCell(new Paragraph(summary.getOperationalLimitations(),new Font(BaseFont.createFont(), 12,Font.NORMAL)));
				//table4.addCell("Operational Limitations Including The Reasons");
				table4.addCell(new Phrase("Operational Limitations Including The Reasons:", new Font(BaseFont.createFont(), 12,Font.ITALIC)));
				cell3.setFixedHeight(30f);
				cell3.setHorizontalAlignment(Element.ALIGN_CENTER);
				cell3.setBorder(PdfPCell.NO_BORDER);
				table4.addCell(cell3);
				PdfPCell cell4 = new PdfPCell(new Paragraph(summary.getInspectionTestingDetailed(),new Font(BaseFont.createFont(), 12,Font.NORMAL)));
//				table4.addCell(
//						"The inspection and testing detailed in this report have been carried out in accordance with IEC60364. It should be note that cables concealed within trunk/trench and conduits, under floors and generally within the fabric of the building or underground, have not been inspected unless specifically agreed between the client and inspector prior to inspection");
				table4.addCell(new Phrase("The inspection and testing detailed in this report have been carried out in accordance with IEC60364. It should be note that cables concealed within trunk/trench and conduits, under floors and generally within the fabric of the building or underground, have not been inspected unless specifically agreed between the client and inspector prior to inspection:", new Font(BaseFont.createFont(), 12,Font.ITALIC)));
...
//			      PdfPCell cell8= new PdfPCell(new Paragraph(summary.get()));
//			       table4.addCell("Referring to attached inspection report and test results and subject to the limitations specified at the extent and limitations of inspection and testing :" );
//			       cell8.setFixedHeight(40f);
//			       cell8.setBorder(PdfPCell.NO_BORDER);
//			      table4.addCell(cell8);
				//PdfPCell cell9 = new PdfPCell(new Paragraph(observation.getObservations(), new Font(BaseFont.createFont(), 12,Font.DEFAULTSIZE)));
				//table4.addCell("Observations");
				...
				Paragraph paragraphOne5= new Paragraph("Referring to attached inspection report and test results and subject to the limitations specified at the extent and limitations of inspection and testing",  new Font(BaseFont.createFont(), 12,Font.ITALIC));
...
//				table6.addCell(cell22);
				...
				addRow(table6, observation.getObservations(),observation.getFurtherActions(), observation.getFurtherActions(),observation.getComment());
				addRow(table6, observation11.getObservations(),observation11.getFurtherActions(), observation11.getFurtherActions(),observation11.getComment());
...
//				table6.addCell(cell12);
			...
			table5.getDefaultCell().setBorder(0);
			 Font font6 = new Font(Font.FontFamily.TIMES_ROMAN, 14,
                      Font.ITALIC | Font.BOLD, BaseColor.BLACK );
	
			Paragraph paragraphOne8= new Paragraph("Recommendations", font6);
			document.add(paragraphOne8);
			PdfPCell cell21 = new PdfPCell(new Paragraph(summary.getRecommendationsDate(),new Font(BaseFont.createFont(), 12,Font.NORMAL)));
//			table4.addCell(
//					"Where the overall assessment of the suitability of the installation for continuous use above is stated as unsatisfactory, I/We recommend that any observations classified as “danger present” (Code C1) or “potentially dangerous” (Code C2) are acted upon the matter of urgency. Investigation without delay is recommended for observations identified as “Required further investigation”. Observations classified as “Improvement recommended” (Code C3) should be given due consideration. Subject to necessary remedial action being taken, I/We recommended that the installation is further inspected and tested by …………Date.:");
			table5.addCell(new Phrase("Where the overall assessment of the suitability of the installation for continuous use above is stated as unsatisfactory, I/We recommend that any observations classified as “danger present” (Code C1) or “potentially dangerous” (Code C2) are acted upon the matter of urgency. Investigation without delay is recommended for observations identified as “Required further investigation”. Observations classified as “Improvement recommended” (Code C3) should be given due consideration. Subject to necessary remedial action being taken, I/We recommended that the installation is further inspected and tested by …………Date.:", new Font(BaseFont.createFont(), 12,Font.ITALIC)));
			...
			document.add(table5);
			      ...
			      PdfPTable table7 = new PdfPTable(pointColumnWidths); // 3 columns.
							...
							PdfPCell cell19= new PdfPCell(new Paragraph(summary.getGeneralConditionInstallation(),new Font(BaseFont.createFont(), 12,Font.NORMAL)));
							table7.addCell(new Phrase("General condition of the installation in terms of electrical safety:", new Font(BaseFont.createFont(), 12,Font.ITALIC)));
							cell19.setFixedHeight(30f);
							cell19.setHorizontalAlignment(Element.ALIGN_CENTER);
							cell19.setBorder(PdfPCell.NO_BORDER);
							table7.addCell(cell19);
							PdfPCell cell20= new PdfPCell(new Paragraph(summary.getOverallAssessmentInstallation(),new Font(BaseFont.createFont(), 12,Font.NORMAL)));
							table7.addCell(new Phrase("Overall assessment of the installation in terms of suitability of continuous use:", new Font(BaseFont.createFont(), 12,Font.ITALIC)));
              ...
              PdfPTable table = new PdfPTable(3); // 3 columns.
				...
				Paragraph paragraphThree = new Paragraph("Section 5:",font3);
		
				document.add(paragraphThree);
				Paragraph paragraphTwo = new Paragraph("Declaration",font3);
	
				document.add(paragraphTwo);
				Paragraph paragraph1 = new Paragraph("I/we being the person responsible for the inspection & testing  of the electrical installation (as indicated by my/our signatures below), particulars of which are described in this report, having exercised reasonable skill and care when carrying out the inspection and testing, hereby declare that information in this report including the observations provides an accurate assessment of condition of electrical installation taking into account the stated extent and limitations in part 5 of this report",new Font(BaseFont.createFont(), 12,Font.ITALIC ));
			
				document.add(paragraph1);
//				PdfPCell cell18 = new PdfPCell(new Paragraph("Section 5:",new Font(BaseFont.createFont(), 12,Font.BOLDITALIC)));
