...
/**
 * The persistent class for the ni_supplycharacteristics_table database table.
 * 
 */
@Entity
@Table(name="ni_supplycharacteristics_table")
@NamedQuery(name="NiSupplycharacteristicsTable.findAll", query="SELECT n FROM NiSupplycharacteristicsTable n")
public class NiSupplycharacteristicsTable implements Serializable {
	...
	public NiSupplycharacteristicsTable() {
	}
