...
/**
 * The persistent class for the ni_details_main_protective database table.
 * 
 */
@Entity
@Table(name="ni_details_main_protective")
@NamedQuery(name="NiDetailsMainProtective.findAll", query="SELECT n FROM NiDetailsMainProtective n")
public class NiDetailsMainProtective implements Serializable {
	...
	//bi-directional one-to-one association to NiDetailsMainProtectiveAddlocation
	@OneToOne(mappedBy="niDetailsMainProtective")
	private NiDetailsMainProtectiveAddlocation niDetailsMainProtectiveAddlocation;

	public NiDetailsMainProtective() {
	}
	...
	public NiDetailsMainProtectiveAddlocation getNiDetailsMainProtectiveAddlocation() {
		return this.niDetailsMainProtectiveAddlocation;
	}

	public void setNiDetailsMainProtectiveAddlocation(NiDetailsMainProtectiveAddlocation niDetailsMainProtectiveAddlocation) {
		this.niDetailsMainProtectiveAddlocation = niDetailsMainProtectiveAddlocation;
	}
