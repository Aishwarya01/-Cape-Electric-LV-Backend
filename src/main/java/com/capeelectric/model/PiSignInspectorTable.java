...
/**
 * The persistent class for the pi_sign_inspector_table database table.
 * 
 */
@Entity
@Table(name="pi_sign_inspector_table")
@NamedQuery(name="PiSignInspectorTable.findAll", query="SELECT p FROM PiSignInspectorTable p")
public class PiSignInspectorTable implements Serializable {
