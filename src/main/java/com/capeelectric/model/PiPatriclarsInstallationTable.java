...
/**
 * The persistent class for the pi_patriclars_installation_table database table.
 * 
 */
@Entity
@Table(name="pi_patriclars_installation_table")
@NamedQuery(name="PiPatriclarsInstallationTable.findAll", query="SELECT p FROM PiPatriclarsInstallationTable p")
public class PiPatriclarsInstallationTable implements Serializable {
	...
	//bi-directional one-to-one association to PiPatriclarsInstallationAddlocation
	@OneToOne(mappedBy="piPatriclarsInstallationTable")
	private PiPatriclarsInstallationAddlocation piPatriclarsInstallationAddlocation;

	public PiPatriclarsInstallationTable() {
	}
	...
	public PiPatriclarsInstallationAddlocation getPiPatriclarsInstallationAddlocation() {
		return this.piPatriclarsInstallationAddlocation;
	}

	public void setPiPatriclarsInstallationAddlocation(PiPatriclarsInstallationAddlocation piPatriclarsInstallationAddlocation) {
		this.piPatriclarsInstallationAddlocation = piPatriclarsInstallationAddlocation;
	}
