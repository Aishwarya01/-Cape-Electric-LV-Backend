...
/**
 * The persistent class for the pi_details_switch_circuit_breaker database table.
 * 
 */
@Entity
@Table(name="pi_details_switch_circuit_breaker")
@NamedQuery(name="PiDetailsSwitchCircuitBreaker.findAll", query="SELECT p FROM PiDetailsSwitchCircuitBreaker p")
public class PiDetailsSwitchCircuitBreaker implements Serializable {
	...
	public PiDetailsSwitchCircuitBreaker() {
	}
