...
/**
 * The persistent class for the ni_sign_inspector_table database table.
 * 
 */
@Entity
@Table(name="ni_sign_inspector_table")
@NamedQuery(name="NiSignInspectorTable.findAll", query="SELECT n FROM NiSignInspectorTable n")
public class NiSignInspectorTable implements Serializable {
