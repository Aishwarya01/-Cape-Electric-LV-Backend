 ...
 * import org.mockito.junit.jupiter.MockitoExtension; import org.slf4j.Logger;
 ...
 * 
 * import com.capeelectric.exception.RegistrationException; import
 ...
 * com.capeelectric.service.RegistrationService; import
 * com.capeelectric.service.impl.AWSEmailService;
 * 
 * @ExtendWith(SpringExtension.class)
 * 
 * @ExtendWith(MockitoExtension.class) public class RegistrationControllerTest {
 * 
 * private static final Logger logger =
 * LoggerFactory.getLogger(RegistrationControllerTest.class);
 * 
 ...
 * 
 * @MockBean private RegistrationException registrationException;
 * 
 * @MockBean private AWSEmailService awsEmailService;
 * 
 * @MockBean private RegistrationRepository registerRepository;
 * 
 * private Register register;
 * 
 * { register = new Register(); register.setUsername("lvsystem@capeindia.net");
 * register.setPassword("moorthy"); register.setApplicationType("LV,HV,EMC");
 * register.setPermission("YES");
 * register.setComment("your company information not avilable");
 * 
 * }
 * 
 * @Test public void testAddRegistration() throws UserException,
 * URISyntaxException, IOException, MessagingException, RegistrationException {
 ...
 * );
 * 
 * ResponseEntity<Void> addRegistration =
 ...
 * logger.
 * info("RegistrationControllerTest testRetrieveRegistration_funcion Started");
 * 
 * when(registrationService.retrieveRegistration("lvsystem@capeindia.net")).
 * thenReturn(Optional.of(register));
 * 
 * Optional<Register> retrieveRegistration =
 * registrationController.retrieveRegistration(register.getUsername());
 * 
 * assertEquals(retrieveRegistration.get().getUsername(),
 * "lvsystem@capeindia.net"); logger.
 * info("RegistrationControllerTest testRetrieveRegistration_funcion Ended");
 * 
 * }
 * 
 * 
 * @Test public void testUpdateRegistration() throws RegistrationException,
 * MessagingException, IOException { logger.
 * info("RegistrationControllerTest testUpdateRegistration_funcion Started");
 * 
 * doNothing().when(registrationService).updateRegistration(register);
 * doNothing().when(awsEmailService).sendEmail(register.getUsername(),
 * "You have successfully updated your profile"); ResponseEntity<String>
 * updateRegistration = registrationController.updateRegistration(register);
